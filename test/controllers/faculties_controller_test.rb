...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { course_id: @faculty.course_id, teachersAssistant: @faculty.teachersAssistant, user_id: @faculty.user_id } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { course_id: @faculty.course_id, teachersAssistant: @faculty.teachersAssistant, user_id: @faculty.user_id } }
