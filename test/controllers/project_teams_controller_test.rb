...
class ProjectTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_team" do
    assert_difference('ProjectTeam.count') do
      post project_teams_url, params: { project_team: { project_id: @project_team.project_id, score: @project_team.score, team_id: @project_team.team_id } }
    end
  ...
  test "should update project_team" do
    patch project_team_url(@project_team), params: { project_team: { project_id: @project_team.project_id, score: @project_team.score, team_id: @project_team.team_id } }
